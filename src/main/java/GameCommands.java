...
public class GameCommands
{
    ...
    public GameCommands(Map<String, Command> map)
    {
        ...
        map.put("stones", new Command("stones", "Stones and Cups is a code-breaking game. Guess the stones in the correct order to win! You have 7 turns to guess.", BotUtils.BOT_PREFIX + "stones", AccessLevel.EVERYONE, new Command[]
                {
                        new Command("start", "Starts a game", "start", AccessLevel.EVERYONE, ((event, args) ->
                        {
                            //DMs only
                        ...
                        new Command("quit", "Quits a game", "quit", AccessLevel.TESTER, ((event, args) ->
                        {
                            if (event.getGuild() == null)
                            {
                                if (args.size() == 1)
                        ...
                        new Command("g", "Make a guess", "g <order>", AccessLevel.EVERYONE, ((event, args) ->
                        {
                        ...
                        new Command("stats", "Calculate your statistics", "stats", AccessLevel.EVERYONE, ((event, args) ->
                        {
                            if (event.getGuild() == null)
                            {
                        ...
                        new Command("all_stats", "Create graph of all statistics", "all_stats", AccessLevel.TESTER, ((event, args) ->
                        {
